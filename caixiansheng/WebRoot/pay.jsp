...
<body>
    ...
    <%
    	Order od = new Order();
    	od = (Order)session.getAttribute("neworder");
        //商户订单号，商户网站订单系统中唯一订单号，必填
        String out_trade_no = od.getOnumber();


        //付款金额，必填
        String total_fee = Double.toString(od.getOprice());
      %>
    ...
    <div class="content">
        <form action="<%=path %>/pay_payorder.action"  method="POST" >
            <div class="element" style="margin-top:60px;">
          
            </div>
            <div class="element">
                <div class="etitle">商户订单号:</div>
                <div class="einput"><font><%=out_trade_no %></font></div>
                <br>
             </div>
            ...
            <div class="element">
                ...
                <div class="einput"><font><%=total_fee %></font></div>
                <br>
